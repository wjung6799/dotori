...
const invoiceSchema = new mongoose.Schema({
  ...
  // One invoice, charged over up to three months. The family authorises the card
  // once; the first instalment is taken there and then and the rest are charged
  ...
  plan: {
    ...
    // Saved so later instalments can be taken without the family present.
    ...
    status: {
      type: String,
      // active  → more instalments to take
      // complete→ every instalment cleared
  ...
  // full, one per instalment on a plan.
  payments: {
    type: [
      new mongoose.Schema(
        {
