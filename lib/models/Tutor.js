...
const tutorSchema = new mongoose.Schema({
  ...
  // False = this instructor's teaching is sold as CLASSES (catalog + enrollment
  // + invoice), not as session packs: the credits page neither lists them nor
  // falls back to the school-wide ladder for them. Yesol converted 2026-09-07.
  sellsSessions: { type: Boolean, default: true },
