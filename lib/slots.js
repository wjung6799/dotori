  ...
  for (let i = 0; i < dayCount; i++) {
    ...
    for (const s of schedules) {
      ...
      out.push({
        ...
        kind: s.kind || 'session',
        // Semi-private or private, exactly as the tutor declared it — or null
        // for a row opened before kinds existed. Not guessed from the seat count
        // here: an undeclared slot takes any credit (lib/booking.js), and a
        // guess stamped on it would have the booking page tell a family they
        // need a kind of credit the slot never required.
