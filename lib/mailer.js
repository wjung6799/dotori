...
// SMTP transport. Inert until SMTP_* env vars are set; calls will throw and the
// callers all wrap sends in try/catch so a missing config never breaks the flow.
