...
export function packsForTutor(tutor, sessionType = null) {
  // An instructor sold as classes (catalog seats, not packs) sells no packs at
  // all — including the school-wide fallback ladder.
  if (tutor?.sellsSessions === false) return [];
