...
//       alongside a fee-free standard channel (Zelle, check). Visa allows these
//       for education merchants, they MAY be charged on debit cards, and they
//       need no card-network registration. Two things keep it a convenience fee
//       rather than a surcharge in disguise: the fee is a FIXED AMOUNT, never a
//       percentage (hence feeTiers below), and the online channel offers only
//       card, so the fee applies to everything in it. The school must genuinely
//       keep taking Zelle and checks without a fee, or none of this holds.
//
