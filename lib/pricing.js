...
export function tutorPackId(sessions, ratePerHour, hours) {
  return `t${Math.round(sessions)}x${Math.round(ratePerHour * 100)}h${Math.round(hours * 10)}`;
}
  ...
  return rates
    ...
    .map((r) => {
      ...
      return {
        ...
        // else's prices.
        id: tutorPackId(sessions, r.ratePerHour, hours),
