        ...
        text('koreanTabLabel', 'Korean', 'Korean tab label'),
        {
          ...
          fields: [
            ...
            text('curriculumHeading', '', 'Curriculum section heading (optional)'),
            {
              ...
              fields: [
                text('label', ''),
                { name: 'file', type: 'upload', relationTo: 'media', label: 'Uploaded PDF (overrides the link below)' },
                text('href', '', 'Link/path fallback (used if no file uploaded)'),
              ],
            },
          ],
        },
      ...
      fields: [
        ...
        area('mathBody', 'School math, test prep, AMC competition math, physics, and coding. Real understanding that shows up in grades and scores.'),
        {
          ...
          defaultValue: [
            ...
            { title: 'A clear starting point', body: 'We meet each student first and show you where they stand before you commit to anything.' },
          ],
        },
        text('foundersHeading', 'Meet the founders'),
        text('closingHeading', 'Questions? Get in touch'),
        area('closingBody', 'Tell us about your child and we’ll help you find the right class. No obligation.'),
        text('closingCtaText', 'Contact Us'),
      ],
    },
      ...
      fields: [
        text('idealForHeading', 'Dotori School is ideal for'),
        {
          ...
          defaultValue: [
            ...
            { text: 'Upper-elementary through high school students raising their math grades with Dotori Math' },
            { text: 'Students preparing for standardized tests such as the SAT and AP exams' },
        ...
        area('founderCtaBody', 'Discover how Dotori can help your child thrive in reading and writing. The best first step is to reach out. Tell us about your child, and we’ll build the right plan together.'),
