...
// One program card, shared by the Literacy page (tabbed, client) and the Korean
// page (flat list, server). Pure presentational: no hooks, no state.
export default function ProgramCard({ p, style }) {
  return (
    <div className="program-card animate-in" data-category={p.category} style={style}>
      <h3>{p.title}</h3>
