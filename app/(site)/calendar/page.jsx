    ...
    <main>
      ...
      <div className="container">
        ...
        <div style={{ border: '1px solid #e0dbd4', borderRadius: 12, padding: '1.5rem', marginBottom: '3rem' }}>
          ...
          <div style={{ marginTop: '1.5rem', background: '#fbf6e9', border: '1px solid #ecd9a8', borderRadius: 8, padding: '0.9rem 1.1rem', fontSize: '0.82rem', color: '#6b5b47', lineHeight: 1.6 }}>
            <div>• Students who miss a class may schedule up to two (2) 30-minute 1:1 make-up sessions.</div>
            <div>• Cancellations and full refunds are available a week before the first class begins.</div>
          </div>
